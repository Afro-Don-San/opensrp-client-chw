...
import org.smartregister.chw.interactor.PathfinderRiskAssessmentInteractor;
...
public class PathfinderRiskAssessmentVisitActivity extends BasePathfinderFpFollowUpVisitActivity {
    ...
    protected void registerPresenter() {
        presenter = new PathfinderFpFollowUpVisitPresenter(memberObject, this, new PathfinderRiskAssessmentInteractor());
    }

    @Override
    public void onBackPressed() {
        displayExitDialog(() -> PathfinderRiskAssessmentVisitActivity.this.finish());
