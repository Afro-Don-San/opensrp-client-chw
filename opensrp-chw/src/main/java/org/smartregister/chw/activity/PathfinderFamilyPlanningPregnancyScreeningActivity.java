...
import org.smartregister.chw.presenter.PathfinderFpPregnancyScreeningPresenter;
...
public class PathfinderFamilyPlanningPregnancyScreeningActivity extends BasePathfinderFpFollowUpVisitActivity {
    ...
    protected void registerPresenter() {
        presenter = new PathfinderFpPregnancyScreeningPresenter(memberObject, this, new PathfinderFpPregnancyScreeningInteractor());
    }

    @Override
    public void onBackPressed() {
        displayExitDialog(() -> PathfinderFamilyPlanningPregnancyScreeningActivity.this.finish());
