...
public class PathfinderFamilyPlanningMethodChoiceActivity extends CorePathfinderFollowupVisitActivity {

    public static void startMe(Activity activity, PathfinderFpMemberObject memberObject, Boolean isEditMode) {
        Intent intent = new Intent(activity, PathfinderFamilyPlanningMethodChoiceActivity.class);
    ...
    public void redrawHeader(MemberObject memberObject) {
        tvTitle.setText(MessageFormat.format("{0}, {1} \u00B7 {2}", memberObject.getFullName(), memberObject.getAge(), getString(com.adosa.opensrp.chw.fp.R.string.choose_fp_method)));
    }

    @Override
    protected void registerPresenter() {
        presenter = new CorePathfinderFpFollowupVisitPresenter(memberObject, this, new PathfinderFpMethodChoiceInteractor());
    }
