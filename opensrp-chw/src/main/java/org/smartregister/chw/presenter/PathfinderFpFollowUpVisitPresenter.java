 ...
 */
public class PathfinderFpFollowUpVisitPresenter extends BaseAncHomeVisitPresenter {
    public PathfinderFpFollowUpVisitPresenter(MemberObject memberObject, BaseAncHomeVisitContract.View view, BaseAncHomeVisitContract.Interactor interactor) {
