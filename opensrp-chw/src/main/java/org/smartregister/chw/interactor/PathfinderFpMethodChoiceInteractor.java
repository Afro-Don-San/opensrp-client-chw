...
public class PathfinderFpMethodChoiceInteractor extends CorePathfinderFpFollowUpVisitInteractor {

    private Flavor flavor = new PathfinderFpMethodChoiceInteractorFlv();
    ...
    protected String getEncounterType() {
        return PathfinderFamilyPlanningConstants.EventType.CHOOSING_FAMILY_PLANNING_METHOD;
    }
